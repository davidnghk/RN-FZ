...
import SwitchAccountScreen from '../../screens/UserScreens/SwitchAccountScreen';
  ...
  return (
    <UserStack.Navigator
      screenOptions={({navigation}) => ({
        ...
        headerBackImage: () => (
          <HeaderBackButton color={COLOR.headerButtonColor} />
        ),
      ...
      />
      <UserStack.Screen
        name="FontSizeSettingScreen"
        component={FontSizeSettingScreen}
        options={{
      ...
      />
      <UserStack.Screen
        name="SwitchAccountScreen"
        component={SwitchAccountScreen}
        options={{
          headerTitle: t('navigate:switchAccount'),
        }}
      />
      <UserStack.Screen
      ...
      />
      <UserStack.Screen
        name="CreateEmergencyContactScreen"
      ...
      />
      <UserStack.Screen
        name="AccountMemberListScreen"
        component={AccountMemberListScreen}
        options={{
          headerTitle: t('navigate:accountMember'),
        }}
      />
      <UserStack.Screen
        name="InviteAccountMemberScreen"
        component={InviteAccountMemberScreen}
        options={{
      ...
      {/* Ambience Stack */}
      <UserStack.Screen
        name="AmbienceDeviceListScreen"
        component={AmbienceDeviceListScreen}
        options={{
          headerTitle: t('navigate:ambienceList'),
        }}
      />
      <UserStack.Screen
        name="AmbienceDeviceScreen"
        component={AmbienceDeviceScreen}
        options={{
          headerTitle: t('navigate:ambienceDevice'),
        }}
      />
      <UserStack.Screen
        name="AmbienceDeviceChartScreen"
        component={AmbienceDeviceChartScreen}
        options={{
          headerTitle: '',
        }}
      />
