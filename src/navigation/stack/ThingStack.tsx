    ...
    <ThingStack.Navigator
      ...
      <ThingStack.Screen
        ...
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity
              style={{marginLeft: Platform.OS === 'ios' ? 0 : 15}}
              onPress={() => {
                navigation.reset({
                  index: 0,
      ...
      />
      <ThingStack.Screen
        name="AddDeviceCompletedScreen"
        component={AddDeviceCompletedScreen}
        options={{
          headerTitle: '',
        }}
      />
      ...
      />
      <ThingStack.Screen
        name="EditCoordinateScreen"
        component={EditCoordinateScreen}
        options={{
          headerTitle: t('navigate:editInfo'),
        }}
      />
